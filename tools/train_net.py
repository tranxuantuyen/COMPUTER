...
def train_epoch(train_loader, model, optimizer, train_meter, cur_epoch, cfg, writer=None):
    ...
    for cur_iter, (inputs, labels, a,  b, meta) in enumerate(train_loader):
        ...
        writer.add_scalar('Loss/main', loss, cur_iter)
        loss += meta['constrastive_loss']
        writer.add_scalar('Loss/constrastive_loss', meta['constrastive_loss'], cur_iter)
...
def eval_epoch(val_loader, model, val_meter, cur_epoch, cfg):
    ...
    for cur_iter, (inputs, labels, _,  _, meta) in enumerate(val_loader):
